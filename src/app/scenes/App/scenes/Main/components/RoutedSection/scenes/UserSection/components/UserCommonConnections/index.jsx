...
class UserCommonConnections extends Component {
    ...
    renderConnection(connection) {
        return (
            <CommonConnection connection={connection} key={connection.id}/>
        )
    }
    ...
    renderContent = ({width}) => {
        ...
        return (
            <ContentContainer width={width}>
                ...
                {!stick && <FlatButton label={this.open ? 'Hide' : 'Show all'} primary={true} onClick={this.toggleOpen}/>}
            </ContentContainer>
        )
    }
    ...
    render() {
        return (
            <AutoSizer disableHeight={true} commonConnections={this.props.commonConnections} open={this.open}>
                {this.renderContent}
            </AutoSizer>
        )
    }
